...
int __init cardhu_emc_init(void)
{
	...
	ret = gpio_request_one(MEMORY_BOOSTRAP_PIN_AD4, GPIOF_DIR_IN, "memory_bootstrap_ad4");
	if (ret < 0)
		WARN_ON(1);
	mem_bootstrap_ad4 = gpio_get_value(MEMORY_BOOSTRAP_PIN_AD4);

	ret = gpio_request_one(MEMORY_BOOSTRAP_PIN_AD5, GPIOF_DIR_IN, "memory_bootstrap_ad5");
	if (ret < 0)
		WARN_ON(1);
