...
static int __init cardhu_touch_init(void)
{
	...
	gpio_request_one(TEGRA_GPIO_PH4, GPIOF_DIR_IN, "touch-irq");
	gpio_request_one(TEGRA_GPIO_PH6, GPIOF_INIT_LOW, "touch-reset");
	...
	switch(tegra3_get_project_id()){
		...
		case TEGRA3_PROJECT_TF300TL:
			...
			break;
		case TEGRA3_PROJECT_TF700T:
			gpio_request_one(TEGRA_GPIO_PK2, GPIOF_INIT_HIGH, "tp_wake");
#ifdef CONFIG_TOUCHSCREEN_ELAN_TF_3K
